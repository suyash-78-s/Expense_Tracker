      ...
      <div className="savings blue-text">
        ...
        <h5 className="mb-3 blue-text">
          ...
          <span className="red-text">
            Rs{formatAmount(nonEssentialSpending)}
          </span>
          .
        </h5>
        <h5 className="mb-3 blue-text">
          If you were to save 10% of your non-essential expenses, that would be{" "}
          <span className="red-text">RS{formatAmount(PMT)}</span> per month.
        </h5>
        <h5 className="blue-text">
          ...
          <span className="red-text">RS{formatAmount(savings.toFixed(0))}</span>
        </h5>
      </div>
        ...
        <form className="calculator-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <label htmlFor="monthlyContribution">
              Monthly Contribution Amount (RS):
            </label>
            <input
              className="form-control"
